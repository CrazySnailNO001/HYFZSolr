...
public class AllControlMedicineResult {
	...
	@Field(value="auth_id") // 产品ID
	private Integer authId;

	@Field(value="channel_id")
	private String channelId;	//通用名

	@Field(value="control_channel_id")
	private String controlChannelId;	//商品名

	@Field(value="au_control_company_id")
	private String auControlCompanyId;		//药品图片

	@Field(value="division_medicine_id")
	private Integer divisionMedicineId;  //一级分类ID

	@Field(value="authorization_price")
	private Integer authorizationPrice;  //二级分类ID

	@Field(value="status")
	private Integer status;  //三级分类ID

	@Field(value="is_delete")
	private Integer isDelete;  //通用一级分类

	@Field(value="authorization_remark")
	private Integer authorizationRemark;  //通用二级分类

	@Field(value="create_user_id")
	private Integer createUserId; //剂型ID

	@Field(value="create_time")
	private String createTime;	//剂型名称
    ...
    public String getControlChannelId() {
        return controlChannelId;
    }

    public void setControlChannelId(String controlChannelId) {
        this.controlChannelId = controlChannelId;
    }

    public String getAuControlCompanyId() {
        return auControlCompanyId;
    }

    public void setAuControlCompanyId(String auControlCompanyId) {
    ...
    public Integer getAuthorizationPrice() {
        return authorizationPrice;
    }

    public void setAuthorizationPrice(Integer authorizationPrice) {
    ...
    public Integer getAuthorizationRemark() {
        return authorizationRemark;
    }

    public void setAuthorizationRemark(Integer authorizationRemark) {

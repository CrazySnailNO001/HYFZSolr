...
public class DruidConfiguration {
    ...
    public ServletRegistrationBean druidStatViewServlet() {
        ...
        registrationBean.addInitParameter("loginPassword", "hyfz123qwe");
    ...
    @Primary
    public DataSource druidDataSource(@Value("${spring.datasource.jc.url}") String url,
                                      @Value("${spring.datasource.jc.driverClassName}") String driver,
                                      @Value("${spring.datasource.jc.username}") String userName,
                                      @Value("${spring.datasource.jc.password}") String password,
